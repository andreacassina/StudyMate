...
namespace StudyMate.Services
{
    public interface ITaskService
    {
        ...
        IEnumerable<StudyMate.Models.EventViewModel> GetAllLessons(string degreeCourse);
        IEnumerable<StudyMate.Models.EventViewModel> GetAllPersonalEvents(string userId);
